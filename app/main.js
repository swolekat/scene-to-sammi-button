...
let mainWindow;
const init = () => {
  mainWindow = (0,_helpers_window__WEBPACK_IMPORTED_MODULE_0__["default"])("main", {
    width: 1000,
    height: 600,
    webPreferences: {
      ...
      enableRemoteModule: env__WEBPACK_IMPORTED_MODULE_3__.name === "test",
      backgroundThrottling: false
    }
  });
  mainWindow.loadURL(url__WEBPACK_IMPORTED_MODULE_1___default().format({
    pathname: path__WEBPACK_IMPORTED_MODULE_2___default().join(__dirname, "app.html"),
    protocol: "file:",
    slashes: true
  }));
...
module.exports = /*#__PURE__*/JSON.parse('{"name":"development","description":"Add here any environment specific stuff you like."}');
